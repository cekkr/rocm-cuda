nvJPEG 11.6.2.124 headers

By using the software you agree to comply with the terms of the [license](https://gitlab.com/nvidia/headers/cuda/nvjpeg/-/blob/main/LICENSE) agreement 
